                ...
                <tbody>
                    @foreach($operators as $key => $operator)
                        <tr data-entry-id="{{ $operator->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $operator->active ?? '' }}</span>
                            ...
                            <td>
                                @can('operator_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.operators.show', $operator->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('operator_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.operators.edit', $operator->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('operator_delete')
                                    <form action="{{ route('admin.operators.destroy', $operator->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
