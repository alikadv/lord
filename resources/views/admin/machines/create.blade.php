    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.machines.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('productivity') ? 'is-invalid' : '' }}" type="number" name="productivity" id="productivity" value="{{ old('productivity', '1') }}" step="0.0001" required>
