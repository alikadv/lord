...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="group">{{ trans('cruds.product.fields.group') }}</label>
                <input class="form-control {{ $errors->has('group') ? 'is-invalid' : '' }}" type="text" name="group" id="group" value="{{ old('group', 'სკოჩი') }}" required>
                @if($errors->has('group'))
                    <div class="invalid-feedback">
                        {{ $errors->first('group') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', 'ნედლეული') }}">
            ...
            <div class="form-group">
                <label class="required" for="feature_1">{{ trans('cruds.product.fields.feature_1') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.feature_1_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="feature_2">{{ trans('cruds.product.fields.feature_2') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.feature_2_helper') }}</span>
            </div>
            <div class="form-group">
